<?php
include_once "./profile_ops/progress_bar.php";
?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active" >
                   <a class="nav-link" href="javascript:void(0)" onclick="window.open('profile.php','_self')"><i class="far fa-user"></i>Profile</a>
                </li>
            </ul>
        </div>
</nav>
            ...
            <div class="card-body">
                ...
                <?php
                    for($i=0;$i<sizeof($arr);$i++){
                        echo "<a href='#'>".$arr[$i]."</a><br>";
                        echo 
                        '<div class="progress">
                            <div class="progress-bar progress-bar-striped active" role="progressbar"
                                aria-valuenow="'.$arrayProgress[$i].'" aria-valuemin="0" aria-valuemax="100" style="width:'.$arrayProgress[$i].'%">'.
                                $arrayProgress[$i].'%
                            </div>
                        </div>';
                    }
